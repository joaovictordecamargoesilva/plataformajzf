...
// --- Main Component ---
const DocumentView: React.FC<DocumentViewProps> = ({ documents, setDocuments, currentUser, clients, users, addNotification, documentTemplates, directAction, setDirectAction, setTasks, activeClientId, setIsLoading, employees, handleDeleteEmployee }) => {
        ...
        try {
            if (editingDoc) {
                ...
                if (selectedTemplate.id === 'rescisao-contrato') {
                    const employeeIdToTerminate = Number(data.formData.nome_funcionario_rescisao);
                    if (employeeIdToTerminate) {
                        await handleDeleteEmployee(employeeIdToTerminate);
                    }
                }
