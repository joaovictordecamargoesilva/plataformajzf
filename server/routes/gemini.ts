...
const cnpjLookup = async (req: express.Request, res: express.Response) => {
    try {
        const { cnpj } = req.body;
...
const analyzeQuickSend = async (req: express.Request, res: express.Response) => {
...
const analyzeTimeSheet = async (req: express.Request, res: express.Response) => {
    if (!ai) return res.status(503).json({ message: "A API do Gemini não foi inicializada." });
    try {
...
const analyzeBulkTimeSheet = async (req: express.Request, res: express.Response) => {
    if (!ai) return res.status(503).json({ message: "A API do Gemini não foi inicializada." });
    try {
...
const findFinancialOpportunities = async (req: express.Request, res: express.Response) => {
     if (!ai) return res.status(503).json({ message: "A API do Gemini não foi inicializada." });
    try {
...
const checkCompliance = async (req: express.Request, res: express.Response) => {
    if (!ai) return res.status(503).json({ message: "A API do Gemini não foi inicializada." });
    try {
        const { client } = req.body as { client: Client };
        const prompt = `
...
const chatbot = async (req: express.Request, res: express.Response) => {
    if (!ai) return res.status(503).json({ message: "A API do Gemini não foi inicializada." });
