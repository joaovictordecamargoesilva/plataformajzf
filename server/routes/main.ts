...
const setActiveClient = async (req: express.Request, res: express.Response) => {
    const user = req.user as User;
...
const addNotification = async (req: express.Request, res: express.Response) => {
...
const markNotificationRead = async (req: express.Request, res: express.Response) => {
    const user = req.user as User;
...
const markAllNotificationsRead = async (req: express.Request, res: express.Response) => {
    const user = req.user as User;
