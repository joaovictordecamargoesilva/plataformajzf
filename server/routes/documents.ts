...
const getDocumentUpdates = async (req: express.Request, res: express.Response) => {
...
const updateDocumentStatus = async (req: express.Request, res: express.Response) => {
...
const createDocumentRequest = async (req: express.Request, res: express.Response) => {
...
const sendFromAdmin = async (req: express.Request, res: express.Response) => {
...
const createFromTemplate = async (req: express.Request, res: express.Response) => {
...
const updateFromTemplate = async (req: express.Request, res: express.Response) => {
    const docId = parseInt(req.params.id, 10);
...
const approveDocumentStep = async (req: express.Request, res: express.Response) => {
    const docId = parseInt(req.params.id, 10);
...
const signDocument = async (req: express.Request, res: express.Response) => {
    const docId = parseInt(req.params.id, 10);
...
const createQuickSend = async (req: express.Request, res: express.Response) => {
