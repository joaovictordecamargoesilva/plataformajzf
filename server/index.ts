...
const prismaMiddleware = (req: express.Request, res: express.Response, next: express.NextFunction) => {
    req.prisma = prisma;
    next();
};
...
if (process.env.NODE_ENV === 'production') {
    ...
    const frontendHandler = (req: express.Request, res: express.Response, next: express.NextFunction) => {
