...
import { User as PrismaUser, Client as PrismaClientModel } from '.prisma/client';
...
export const toAppUser = (dbUser: PrismaUser & { clients?: PrismaClientModel[] }): User => {
    ...
    const appUser: User = {
        ...
        clientIds: dbUser.clients?.map((c: PrismaClientModel) => c.id) || [],
    };
