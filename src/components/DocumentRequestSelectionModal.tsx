        ...
        if (pendingSelection) {
            return (
                <>
                    ...
                    <p className="text-gray-700 mb-4">Você está solicitando o documento: <strong>{pendingSelection}</strong></p>
                    <textarea 
                        value={observation}
                    ...
                    <div className="mt-6 flex justify-between items-center">
                        ...
                        <button onClick={() => onSelect(pendingSelection, observation)} className="bg-primary text-white font-bold py-2 px-4 rounded-lg">Confirmar Solicitação</button>
                    </div>
                </>
            );
        }
             ...
             return (
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {(Object.keys(documentRequestLists) as Category[]).map(cat => (
