...
import { User, Client, Invoice, Document, Task, Employee } from '../types';
...
const ClientDashboardView: React.FC<ClientDashboardViewProps> = ({ clients, invoices, documents, tasks, employees, viewingClientId, setCurrentView }) => {
