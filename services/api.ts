import { User, Client, Invoice, AppNotification, TaskTemplateSet, Employee, TimeSheet, Document, Signature, Task, TaskStatus, DocumentTemplate, Settings, Opportunity, ComplianceFinding, DocumentStatus } from '../types.js';
...
export const analyzeBulkTimeSheet = async (
    fileContentBase64: string,
    mimeType: string,
    clientId: number,
    month: number,
